...
def test_benchmark_hdstats_as_delivered(benchmark, arr, kwargs_parallel):
    from hdstats_ad import nangeomedian, smad_pcm, emad_pcm
...
def test_benchmark_hdstats_pcm_as_delivered(benchmark, arr, kwargs_parallel):
